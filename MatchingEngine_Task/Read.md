...
Project type: Automation (UI tests)

Chrome dependency:
chrome.exe version: CHROME_EXE_VERSION_HERE

Notes:
- Replace CHROME_EXE_VERSION_HERE with the exact chrome.exe version consumed by this project (for example, 151.0.7922.138, 152.0.5845.96).
